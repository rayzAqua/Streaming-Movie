        ...
        <div class="bg-main">
            <div class="container px-6 py-8 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
                    {pricing.map((p)=>(
                        <div key={p.id} class="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                            ...
                            {
                                user?
                                <button type='button' onClick={handleBtn} key={p.id} data-id={p.id} class="block w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                                    Register Now
                                </button>:
                                <button key={p.id} onClick={handleLogin} class="w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                                    Register Now
                                </button>
