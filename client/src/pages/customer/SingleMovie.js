...
const handleBtn = async (e) => {
  ...
  try {
      const response = await axiosApiInstance.post(`/payment/forFilm/${movie.id}?days=${days}`);
    ...
    <Layout>
      {
        ...
        (
          <div className='relative'>
              ...
              <div class="absolute z-50 top-0 left-0 bottom-0 right-0 px-6 py-8 bg-dry bg-opacity-40">
                ...
                <div class="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
                  <div class="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                      <p class="font-medium text-gray-200 uppercase">1 DAY WATCHING {" " + movie.title}</p>
                      ...
                      {
                          user?
                          <button type='button' onClick={handleBtn} data-days={1} class="block w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                              Register Now
                          </button>:
                  ...
                  <div class="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                      <p class="font-medium text-gray-200 uppercase">2 DAYS WATCHING {" " + movie.title}</p>
                      ...
                      {
                          user?
                          <button type='button' onClick={handleBtn} data-days={2} class="block w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                              Register Now
                          </button>:
                          <button onClick={handleLogin} class="w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                              Register Now
                  ...
                  <div class="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                      <p class="font-medium text-gray-200 uppercase">3 DAYS WATCHING {" " + movie.title}</p>
                      ...
                      {
                          user?
                          <button type='button' onClick={handleBtn} data-days={3} class="block w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                              Register Now
                          </button>:
                          <button onClick={handleLogin} class="w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                              Register Now
            ...
            <MovieInfo movie={movie} user={user} checkFavorite={checkFavorite} setCheckFavorite={setCheckFavorite} rate={rate} setLoadFavorite={setLoadFavorite} setShow={setShow}/>
